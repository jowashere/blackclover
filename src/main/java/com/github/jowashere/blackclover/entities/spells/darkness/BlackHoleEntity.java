...
public class BlackHoleEntity extends Entity {
    ...
    public BlackHoleEntity(EntityType<? extends BlackHoleEntity> type, World worldIn)
    {
        super(type, worldIn);
    }

    public BlackHoleEntity(World worldIn, LivingEntity owner, float manaIn) {
        super(EntityInit.BLACK_HOLE.get(), worldIn);
    ...
    public void tick()
    {
        ...
        List<AbstractSpellProjectileEntity> spellProjectiles = BCMHelper.GetEntitiesNear(this.getOnPos(), this.level, 16, AbstractSpellProjectileEntity.class);
