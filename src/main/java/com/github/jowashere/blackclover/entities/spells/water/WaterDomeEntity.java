...
public class WaterDomeEntity extends Entity {
    ...
    public WaterDomeEntity(EntityType<? extends WaterDomeEntity> type, World worldIn)
    {
        super(type, worldIn);
    }

    public WaterDomeEntity(World worldIn, LivingEntity owner, float manaIn) {
