...
public class DarkParticleFactory implements IParticleFactory<DarkParticleData> {
    @Nullable
    @Override
    public Particle createParticle(DarkParticleData darkParticleData, ClientWorld world, double xPos, double yPos, double zPos, double xVelocity, double yVelocity, double zVelocity) {
        DarkParticle newParticle = new DarkParticle(world, xPos, yPos, zPos, xVelocity, yVelocity, zVelocity,
                darkParticleData.getTint(), darkParticleData.getDiameter(),
                sprites);
    ...
    public DarkParticleFactory(IAnimatedSprite sprite) {
        this.sprites = sprite;
    }
    ...
    private DarkParticleFactory() {
        throw new UnsupportedOperationException("Use the DarkParticleFactory(IAnimatedSprite sprite) constructor");
    }
