package com.github.jowashere.blackclover.init.spells.darkness;
...
public class DarkCloakedBlade extends AbstractToggleSpell {
    ...
    public DarkCloakedBlade(IBCMPlugin plugin) {
        super(plugin, "dark_cloaked_blade", AttributeInit.DARKNESS);
