...
public class StructuresInit
{
     ...
     */
    public static <F extends net.minecraft.world.gen.feature.structure.Structure<?>> void setupMapSpacingAndLand(
            F structure,
            ...
            boolean transformSurroundingLand)
    {
         ...
         */
        net.minecraft.world.gen.feature.structure.Structure.STRUCTURES_REGISTRY.put(structure.getRegistryName().toString(), structure);
        ...
        WorldGenRegistries.NOISE_GENERATOR_SETTINGS.entrySet().forEach(settings -> {
            Map<net.minecraft.world.gen.feature.structure.Structure<?>, StructureSeparationSettings> structureMap = settings.getValue().structureSettings().structureConfig();
