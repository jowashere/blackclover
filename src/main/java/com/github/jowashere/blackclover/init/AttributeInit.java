...
public class AttributeInit {
    ...
    public static final BCMAttribute SLASH = new BCMAttribute("slash", 20, true, 0, 80,  AbstractSpell.Type.SLASH_MAGIC).setAttributeMessage("You have Slash Magic.").setAttributeColour(1).setGrimoireTextures(GrimoireTextures.SlashGrimoires);
