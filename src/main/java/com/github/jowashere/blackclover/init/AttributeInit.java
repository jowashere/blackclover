...
public class AttributeInit {
    ...
    public static final BCMAttribute SWORD = new BCMAttribute("sword", 20, false, 0, 0,  BCMSpell.Type.SWORD_MAGIC).setAttributeMessage("You have Sword Magic").setAttributeColour(8).setSpellAdder(new AddSwordSpells()).setGrimoireTextures(GrimoireTextures.AntiMagicGrimoires);
