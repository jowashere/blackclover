package com.github.jowashere.blackclover.client.renderer.spells.projectiles.sword;
...
@OnlyIn(Dist.CLIENT)
public class OriginFlashRenderer extends EntityRenderer<OriginFlashEntity>{
    ...
    public OriginFlashRenderer(EntityRendererManager renderManagerIn) {
        super(renderManagerIn);
    }

    @Override
    public void render(OriginFlashEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
    ...
    public static class Factory implements IRenderFactory<OriginFlashEntity> {

        @Override
        public EntityRenderer<? super OriginFlashEntity> createRenderFor(EntityRendererManager manager) {
            return new OriginFlashRenderer(manager);
        }
    }

    @Override
    public ResourceLocation getTextureLocation(OriginFlashEntity entity) {
        return texture;
    }
