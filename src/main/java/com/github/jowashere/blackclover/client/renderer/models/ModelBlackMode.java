...
public class ModelBlackMode<T extends LivingEntity> extends BipedModel<T> {
    ...
    public ModelBlackMode(boolean isSlim) {
        ...
        Body2.texOffs(24, 16).addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, 0.02F, false);
