package com.github.jowashere.blackclover.client.renderer.spells.projectiles.antimagic;
...
@OnlyIn(Dist.CLIENT)
public class BlackSlashRenderer extends EntityRenderer<BlackSlashEntity>{

    private static final ResourceLocation texture = new ResourceLocation("blackclover:textures/entities/projectiles/blackslash.png");

    public BlackSlashRenderer(EntityRendererManager renderManagerIn) {
        super(renderManagerIn);
    }

    @Override
    public void render(BlackSlashEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
    ...
    public static class Factory implements IRenderFactory<BlackSlashEntity> {
        @Override
        public EntityRenderer<? super BlackSlashEntity> createRenderFor(EntityRendererManager manager) {
            return new BlackSlashRenderer(manager);
        }
    }

    @Override
    public ResourceLocation getTextureLocation(BlackSlashEntity entity) {
        return texture;
    }
