...
import com.github.jowashere.blackclover.common.curios.network.client.CPacketDestroy;
...
public class GuiEventHandler {
  ...
  public void onMouseClick(GuiScreenEvent.MouseClickedEvent.Pre evt) {
    ...
    if (gui.getSelectedTab() != ItemGroup.TAB_INVENTORY.getId()) {
      return;
    }
    ...
    if (destroyItemSlot != null && slot == destroyItemSlot) {
      NetworkLoader.INSTANCE.send(PacketDistributor.SERVER.noArg(), new CPacketDestroy());
    }
  }
}