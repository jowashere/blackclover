...
import com.github.jowashere.blackclover.entities.spells.water.WaterDragonEntity;
...
@OnlyIn(Dist.CLIENT)
public class WaterDragonRender extends EntityRenderer<WaterDragonEntity> {

	private static final ResourceLocation texture = new ResourceLocation("blackclover:textures/entities/projectiles/waterdragon.png");
	public WaterDragonRender(EntityRendererManager renderManagerIn) {
		super(renderManagerIn);
	}

	@Override
	public void render(WaterDragonEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
		...
		EntityModel model = new Waterdragon_model();
		model.renderToBuffer(matrixStackIn, vb, packedLightIn, OverlayTexture.NO_OVERLAY, 1, 1, 1, 0.0625f);
		matrixStackIn.popPose();
		super.render(entityIn, entityYaw, partialTicks, matrixStackIn, bufferIn, packedLightIn);
	}

	public static class Factory implements IRenderFactory<WaterDragonEntity> {

		@Override
		public EntityRenderer<? super WaterDragonEntity> createRenderFor(EntityRendererManager manager) {
			return new WaterDragonRender(manager);
		}
	}

	@Override
	public ResourceLocation getTextureLocation(WaterDragonEntity p_110775_1_) {
		return texture;
	}

	public class Waterdragon_model extends EntityModel<Entity> {
		...
		public Waterdragon_model() {
			...
			WaterDragonHead.texOffs(0, 0).addBox(556.0F, -52.0F, -23.0F, 10.0F, 32.0F, 29.0F, 0.0F, false);
			WaterDragonHead.texOffs(0, 0).addBox(563.0F, -55.0F, -27.0F, 30.0F, 36.0F, 37.0F, 0.0F, false);
			WaterDragonHead.texOffs(0, 0).addBox(591.0F, -54.0F, -26.0F, 10.0F, 34.0F, 35.0F, 0.0F, false);
			...
			HeadD3_r1.texOffs(0, 0).addBox(-35.0F, -18.0F, 0.0F, 50.0F, 36.0F, 0.0F, 0.0F, false);
			...
			HeadD2_r1.texOffs(0, 0).addBox(-35.0F, -18.0F, 0.0F, 50.0F, 36.0F, 0.0F, 0.0F, false);
			...
			HeadD1_r1.texOffs(0, 0).addBox(-30.0F, 0.0F, -20.5F, 51.0F, 0.0F, 41.0F, 0.0F, false);
			...
			WaterDragonBody.texOffs(0, 0).addBox(397.0F, -49.0F, -22.0F, 22.0F, 27.0F, 27.0F, 0.0F, false);
			WaterDragonBody.texOffs(0, 0).addBox(377.0F, -50.0F, -23.0F, 22.0F, 29.0F, 29.0F, 0.0F, false);
			WaterDragonBody.texOffs(0, 0).addBox(357.0F, -50.0F, -23.0F, 22.0F, 29.0F, 29.0F, 0.0F, false);
			WaterDragonBody.texOffs(0, 0).addBox(337.0F, -50.0F, -23.0F, 22.0F, 29.0F, 29.0F, 0.0F, false);
			WaterDragonBody.texOffs(0, 0).addBox(317.0F, -50.0F, -23.0F, 22.0F, 29.0F, 29.0F, 0.0F, false);
			WaterDragonBody.texOffs(0, 0).addBox(298.0F, -50.0F, -23.0F, 22.0F, 29.0F, 29.0F, 0.0F, false);
			WaterDragonBody.texOffs(0, 0).addBox(278.0F, -50.0F, -23.0F, 22.0F, 29.0F, 29.0F, 0.0F, false);
			WaterDragonBody.texOffs(0, 0).addBox(259.0F, -51.0F, -25.0F, 22.0F, 32.0F, 33.0F, 0.0F, false);
			WaterDragonBody.texOffs(0, 0).addBox(239.0F, -51.0F, -25.0F, 22.0F, 32.0F, 33.0F, 0.0F, false);
			WaterDragonBody.texOffs(0, 0).addBox(219.0F, -51.0F, -25.0F, 22.0F, 32.0F, 33.0F, 0.0F, false);
			WaterDragonBody.texOffs(0, 0).addBox(199.0F, -51.0F, -25.0F, 22.0F, 32.0F, 33.0F, 0.0F, false);
			...
			WaterDragonBodyDetails.texOffs(0, 0).addBox(172.0F, -53.0F, -26.0F, 377.0F, 0.0F, 35.0F, 0.0F, false);
			WaterDragonBodyDetails.texOffs(0, 0).addBox(172.0F, -18.0F, -26.0F, 377.0F, 0.0F, 35.0F, 0.0F, false);
			...
			BodyD3_r1.texOffs(0, 0).addBox(172.0F, -51.0F, -26.0F, 377.0F, 0.0F, 35.0F, 0.0F, false);
		}
