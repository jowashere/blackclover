package com.github.jowashere.blackclover.client.renderer.spells.projectiles.darkness;
...
@OnlyIn(Dist.CLIENT)
public class AvidyaSlashRenderer extends EntityRenderer<AvidyaSlashEntity>{
    ...
    public AvidyaSlashRenderer(EntityRendererManager renderManagerIn) {
        super(renderManagerIn);
    }

    @Override
    public void render(AvidyaSlashEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
    ...
    public static class Factory implements IRenderFactory<AvidyaSlashEntity> {

        @Override
        public EntityRenderer<? super AvidyaSlashEntity> createRenderFor(EntityRendererManager manager) {
            return new AvidyaSlashRenderer(manager);
        }
    }

    @Override
    public ResourceLocation getTextureLocation(AvidyaSlashEntity entity) {
        return texture;
    }
