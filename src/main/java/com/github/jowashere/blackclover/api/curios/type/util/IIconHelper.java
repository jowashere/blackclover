...
public interface IIconHelper {
  ...
  /**
   * Adds a {@link ResourceLocation} for the icon to the given {type.ISlotType} identifier
   *
   * @param identifier       The {type.ISlotType} identifier
  ...
  /**
   * @param identifier The identifier of the {type.ISlotType}
