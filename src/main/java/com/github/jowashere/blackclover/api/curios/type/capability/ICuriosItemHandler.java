...
package com.github.jowashere.blackclover.api.curios.type.capability;
...
public interface ICuriosItemHandler {
  ...
  /**
   * A map of the current curios, keyed by the {@link com.github.jowashere.blackclover.api.curios.type.ISlotType} identifier.
   *
  ...
  /**
   * Gets the number of slots across all {@link com.github.jowashere.blackclover.api.curios.type.ISlotType} identifiers.
   *
   ...
   *
   * @return A set of {@link com.github.jowashere.blackclover.api.curios.type.ISlotType} identifiers
   */
  ...
  /**
   * Gets the Optional {@link ICurioStacksHandler} associated with the given {@link com.github.jowashere.blackclover.api.curios.type.ISlotType}
   * identifier or Optional.empty() if it doesn't exist.
   *
   * @param identifier The identifier for the {@link com.github.jowashere.blackclover.api.curios.type.ISlotType}
   * @return The stack handler
   */
  Optional<ICurioStacksHandler> getStacksHandler(String identifier);

  /**
   * Enables the {@link com.github.jowashere.blackclover.api.curios.type.ISlotType} for a given identifier, adding the default settings to the curio
   * map.
   *
   * @param identifier The identifier for the {@link com.github.jowashere.blackclover.api.curios.type.ISlotType}
  ...
  /**
   * Disables the {@link com.github.jowashere.blackclover.api.curios.type.ISlotType} for a given identifier, removing it from the curio map.
   *
   * @param identifier The identifier for the {@link com.github.jowashere.blackclover.api.curios.type.ISlotType}
   */
  ...
  /**
   * Retrieves a set containing the {CuriosStacksHandler} that require its slot modifiers be
   ...
   * <br>
   * Adds an amount of slots to the { ICurioStacksHandler} of a { ISlotType} associated
   * with the identifier.
   */
  @Deprecated
   ...
   * when overriding { ICurio#getAttributeModifiers(SlotContext, UUID)}
   * <p>
   * Removes an amount of slots from the { ICurioStacksHandler} of a {@link com.github.jowashere.blackclover.api.curios.type.ISlotType}
