...
public interface ICurioItem {
   ...
   *
   * @param identifier   The {@link com.github.jowashere.blackclover.api.curios.type.ISlotType} identifier of the slot being
   *                     equipped into
   * @param livingEntity The wearer of the ItemStack
   * @param stack        The ItemStack in question
   ...
   *
   * @param slotContext Context about the slot that the ItemStack was just equipped into
   * @return {ICurio.SoundInfo} containing
   ...
   * @return {@link com.github.jowashere.blackclover.api.curios.type.capability.ICurio.DropRule}
   */
  @Nonnull
