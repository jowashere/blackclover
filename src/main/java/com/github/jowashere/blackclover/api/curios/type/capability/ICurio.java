...
public interface ICurio {
  ...
  static void playBreakAnimation(ItemStack stack, LivingEntity livingEntity) {
    ...
    if (!stack.isEmpty()) {
      ...
      if (!livingEntity.isSilent()) {
        livingEntity.level
            .playSound((PlayerEntity) livingEntity, livingEntity.getX(), livingEntity.getY(),
                livingEntity.getZ(), SoundEvents.ITEM_BREAK, livingEntity.getSoundSource(),
                0.8F + livingEntity.level.random.nextFloat() * 0.4F, 0.8F);
      }

      for (int i = 0; i < 5; ++i) {
        Vector3d vec3d = new Vector3d((livingEntity.getRandom().nextFloat() - 0.5D) * 0.1D,
        ...
        Vector3d vec3d1 = new Vector3d((livingEntity.getRandom().nextFloat() - 0.5D) * 0.3D,
            d0, 0.6D);
   ...
   *
   * @param identifier   The {@link com.github.jowashere.blackclover.api.curios.type.ISlotType} identifier of the ItemStack's slot
   ...
   *
   * @param identifier   The {@link com.github.jowashere.blackclover.api.curios.type.ISlotType} identifier of the slot being equipped into
   * @param livingEntity The wearer of the ItemStack
   ...
   *
   * @param identifier   The {@link com.github.jowashere.blackclover.api.curios.type.ISlotType} identifier of the slot being unequipped from
   * @param livingEntity The wearer of the ItemStack
   ...
   *
   * @param identifier   The identifier of the {@link com.github.jowashere.blackclover.api.curios.type.ISlotType} of the slot
   * @param index        The index of the slot
  ...
  default int getFortuneBonus(String identifier, LivingEntity livingEntity, ItemStack curio,
                              int index) {
    return EnchantmentHelper.getEnchantmentLevel(Enchantments.BLOCK_FORTUNE, livingEntity);
  }
      ...
      if (render instanceof LivingRenderer) {
        ...
        if (model instanceof BipedModel) {
          ...
          for (ModelRenderer renderer : renderers) {
            renderer.copyFrom(((BipedModel<LivingEntity>) model).head);
          }
        }
      }
    }
